...
tinymce.PluginManager.add("eqneditor",function(editor, url) {
	...
	sl.add(http+'latex.codecogs.com/js/eq_config.js');
	sl.add(http+'latex.codecogs.com/js/eq_editor-lite-16.js');
