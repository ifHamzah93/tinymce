	...
	function showDialog() {
		...
		win = editor.windowManager.open({
			...
			buttons : [
					{
						type:'container',
						html:'<span style="font-size:11px;"><a href="http://asciimath.org/#syntax" target="_blank" style="font-size:11px">Help</a> |&nbsp;<a href="http://www.codecogs.com/latex/about.php" target="_blank"  style="font-size:11px">About</a> | <a href="http://ems.primagama.co.id" target="_blank" style="font-size:11px">EMS</a> | <a href="http://www.codecogs.com/pages/forums/forum_view.php?f=28" target="_blank" style="font-size:11px">Forum</a> | <a href="http://www.codecogs.com" target="_blank" style="font-size:11px">CodeCogs</a> &copy; 2016</span>'
					},
					{type: "spacer", flex: 1},
					{
						text: 'Ok',
